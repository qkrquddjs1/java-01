...
public class Application01 {
    public static void main(String[] args) {
        /* java.util.Scanner 를 이용한 다양한 자료형 갑 입력 받기 */
...
//        System.out.println("입력하신 금액은 " + money + "원입니다.");
        ...
        *  정수형으로  입력하면 실수로 변환 후 정상 동작 되나 숫자 형태가 아닌 값은 java.util.InputMismatchException 발생 */
...
//        System.out.println("입력하신 논리 값은 " + isTrue + "입니다. ");
        ...
        * 만약 존재하지 않은 인덱스를 입력하게 되면 java.lang.StringIndexOutOfBoundsException이 발생한다. */
